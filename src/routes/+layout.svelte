<script lang="ts">
  ...
  const siteUrl = "https://systemd-generateor.stefanbogdanovic.dev";
...
<svelte:head>
  ...
  <link rel="icon" type="image/svg+xml" href="/cog.svg" />
  ...
  <meta
    property="og:title"
    content="systemd Unit Generator — Build & Export .service Files"
  />
  <meta
